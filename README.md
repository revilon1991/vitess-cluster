...
![This is an image](https://vitess.io/docs/archive/14.0/overview/img/architecture.svg)

_Picture from [Vitess architecture](https://vitess.io/docs/archive/14.0/overview/architecture/)_

---
_Playground based on Vitess 14._
...
| 2   | [topology](https://vitess.io/docs/archive/14.0/concepts/topology-service/)       | Helps to communicate whole parts of system between each other.                                 |
| 3   | [vtctl](https://vitess.io/docs/archive/14.0/concepts/vtctl/)  (vtctl + vtctld)   | CLI and API service to admin a Vitess cluster.                                                 |
| 4   | [node1](https://vitess.io/docs/archive/14.0/concepts/tablet/) (VTTablet + MySQL) | Contains an instance of a mysql and a tablet, the tablet gives queries and sends to the mysql. |
| 5   | [node2](https://vitess.io/docs/archive/14.0/concepts/tablet/) (VTTablet + MySQL) | same like first node.                                                                          |
| 6   | [node3](https://vitess.io/docs/archive/14.0/concepts/tablet/) (VTTablet + MySQL) | same like first node.                                                                          |
| 7   | [node4](https://vitess.io/docs/archive/14.0/concepts/tablet/) (VTTablet + MySQL) | same like first node.                                                                          |
| 8   | [vtgate](https://vitess.io/docs/archive/14.0/concepts/vtgate/)                   | Gives queries from application and routes that to nodes.                                       |
| 9   | [vtadmin](https://vitess.io/docs/archive/14.0/reference/programs/vtadmin-web/)   | Web interface to view state and admin cluster.                                                 |
...
[Keyspace](https://vitess.io/docs/archive/14.0/concepts/keyspace/) will be `lolspace` for this node.
...
That action name is [MoveTables](https://vitess.io/docs/archive/14.0/user-guides/migration/move-tables/). 
Actual, it needs for [vertical sharding](https://vitess.io/docs/archive/14.0/user-guides/historical/vertical-split/) or preparing to [horizontal sharding](https://vitess.io/docs/archive/14.0/user-guides/historical/horizontal-sharding/).
```shell
...
Also, we'll set [vindex](https://vitess.io/docs/archive/14.0/reference/features/vindexes/) (sharding key) config.
```shell
...
You can see those [here](https://vitess.io/docs/archive/14.0/reference/compatibility/mysql-compatibility/)

More information at [Vitess Documentation](https://vitess.io/docs/archive/14.0/).
